...
public class ProgressBar extends GuiComponent implements Widget, GuiEventListener, NarratableEntry {
    ...
    public void render(@NotNull PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        int xMapped = this.direction.isVertical ? this.xPos : ScreenUtil.mapNumberToRange(this.minXProgress.getAsInt(),
                this.maxXProgress.getAsInt(), this.minWidth, this.maxWidth, progress);
        int yMapped = !this.direction.isVertical ? this.yPos : ScreenUtil.mapNumberToRange(this.minYProgress.getAsInt(),
